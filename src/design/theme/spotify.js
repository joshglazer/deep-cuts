...
/**
 * spotify theme — built by `npx astryx theme build`
...
export const spotifyTheme = {
  ...
  tokens: {
    ...
    "--color-accent": "light-dark(#1DB954, #1DB954)",
    "--color-accent-muted": "light-dark(#1DB95426, #1DB95433)",
    ...
    "--color-text-accent": "light-dark(#1DB954, #1DB954)",
    ...
    "--color-icon-accent": "light-dark(#1DB954, #1DB954)",
